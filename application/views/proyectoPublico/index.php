...
<body>
	...
	<ul class="nav nav-pills">
		...
		<li><a id="menu-top" href="http://localhost/verkami/index.php/proyecto"> Proyectos</a></li>
		<li><a id="menu-top" href="#"> Qué es Verkami</a></li>
		<li><a id="menu-top" href="#"> FAQ</a></li>
		<li><a id="menu-top"> | </a></li>
		<li><a id="menu-top" href="#"> Empieza tu proyecto</a></li>
		<li><a id="menu-top" href="#"> Iniciar Sesión</a></li>
	</ul>
</nav>
	...
	<div class="col-sm-9">
		...
		<div class="media">
		  <div class="media-left media-middle">
		    <a href="http://localhost/verkami/index.php/proyecto">
	...
	<div class="col-sm-2">
		<nav class="navbar-right" >
			<ul>
				...
				<a id="menu-down" href="http://localhost/verkami/index.php/proyecto"> Proyectos</a><br>
